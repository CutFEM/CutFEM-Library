...
#ifndef EXAMPLE_INTERFACE_PROBLEM_STOKES_SOLVER_HPP
#define EXAMPLE_INTERFACE_PROBLEM_STOKES_SOLVER_HPP
...
std::vector<double> stokesSolver(CutFESpace<Mesh2> &Vh, CutFESpace<Mesh2> &Ph, InterfaceLevelSet<Mesh2> &interface,
