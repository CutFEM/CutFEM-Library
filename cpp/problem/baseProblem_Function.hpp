...
template <typename M>
void BaseFEM<M>::addPatchContribution(const itemVFlist_t &VF, const int k,
                                     const int kn, const TimeSlab *In, int itq, double cst_time) {
    ...
    // double measK = K.measure() + Kn.measure();
