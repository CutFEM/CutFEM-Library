...
double integralCut(const ListItemVF<Mesh> &VF, const FunFEM<Mesh> &f, const FunFEM<Mesh> &g,
...
template <typename Mesh>
double integralCut(const ListItemVF<Mesh> &VF, const CutFEM<Mesh> &cutfem, const FunFEM<Mesh> &f, const FunFEM<Mesh> &g,
