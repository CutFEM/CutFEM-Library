...
void MUMPS::info() {
   ...
   //   Storage of the factors " << std::endl; 	std::cout << " Memory " << szlu
   //   << std::endl; 	std::cout << "\n Working memory for factorization   "
   //   << std::endl; 	std::cout << " Memory                       " << szwk <<
   //   std::endl; 	std::cout << std::endl; 	std::cout << " Time of
   //   analysis phase
   //   " << timeAnalysis_ << std::endl; 	std::cout << " Time of
   //   factorization phase          " << timeFactorization_ << std::endl;
   //   std::cout << " Time for solving                     " << timeSolving_ <<
   //   std::endl << std::endl;
   //   }
}
