...
void Darcy2_build_mesh(Darcy2 *darcy, int nx, int ny, R orx, R ory, R lx,
                       R ly) {
...
void Darcy2_delete(Darcy2 *darcy) { darcy->delete_obj(); }
void Darcy2_init_space(Darcy2 *darcy, double (*f)(double *), char *st_type) {
   darcy->init_space(f, std::string(st_type));
}
void Darcy2_add_bulk_integral(Darcy2 *darcy, double (*f)(double *, int, int)) {
   darcy->add_bulk_integral(f);
}
void Darcy2_add_interface_integral(Darcy2 *darcy,
...
int Darcy2_get_nz(Darcy2 *darcy) { return darcy->get_nz(); }
int Darcy2_get_size_A(Darcy2 *darcy) { return darcy->get_size_A(); }
void Darcy2_get_COO_data(Darcy2 *darcy, int32_t *r, int32_t *c, double *v,
                         double *b) {
   darcy->get_COO_data(r, c, v, b);
}
void Darcy2_get_CSR_data(Darcy2 *darcy, int32_t *r, int32_t *c, double *v,
                         double *b) {
   darcy->get_CSR_data(r, c, v, b);
}
void Darcy2_give_back_sol(Darcy2 *darcy, double *x) { darcy->get_back_sol(x); }
