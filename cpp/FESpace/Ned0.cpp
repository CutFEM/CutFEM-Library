...
int TypeOfFE_Ned0_kind1::Data[] { // geometry=vertex,edge,face,volume; 0,1,2 vertices, 3,4,5 edges, 6 face
...
TypeOfFE_Ned0_kind1::TypeOfFE_Ned0_kind1(): GTypeOfFE<Mesh3>(
  6,
  3,
  Data,
...
void  TypeOfFE_Ned0_kind1::get_Coef_Pi_h(const GbaseFElement<Mesh> & K, KN_< double > &v) const // ,int ocoef,int odf,int *nump ) const
{
