...
void TypeOfFE_RT2_2d::FB_Freefem(const What_d whatd, const Element &K, const R2 &Phat, RNMK_ &val) const {
    ...
    R L[3] = {l0, l1, l2};
    R eo[] = {static_cast<R>(K.EdgeOrientation(0)), static_cast<R>(K.EdgeOrientation(1)),
    ...
    int Bii[][3]   = {{0, 0, 0} /* 0 */,  {0, 1, 1} /* 1 */,  {0, 2, 2} /* 2 */,  {0, 1, 2} /* 3 */,  {0, 2, 0} /* 4 */,
                      {0, 0, 1} /* 5 */,  {1, 0, 0} /* 6 */,  {1, 1, 1} /* 7 */,  {1, 2, 2} /* 8 */,  {1, 1, 2} /* 9 */,
                      {1, 2, 0} /* 10 */, {1, 0, 1} /* 11 */, {2, 0, 0} /* 12 */, {2, 1, 1} /* 13 */, {2, 2, 2} /* 14 */,
