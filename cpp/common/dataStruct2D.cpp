...
static const int onWhatIsEdgeQuad[4][9] = {  {1,1,0,0, 2,0,0,0, 0}, // edge 0
                                             {0,1,1,0, 0,2,0,0, 0},
                                             {0,0,1,1, 0,0,2,0, 0},
                                             {1,0,0,1, 0,0,0,2, 0}
                                       };
...
// template<> const int (* const GenericElement<DataTriangle2>::refElement)[3] = nvref ;
template<> const int (* const GenericElement<DataTriangle2>::onWhatBorder)[7] = onWhatIsEdge ;
...
template<> const int (* const GenericElement<DataQuad2>::onWhatBorder)[9] = onWhatIsEdgeQuad ;
...
// template<> const int (* const GenericElement<DataSeg2>::refElement)[2] = nvrefSeg ;
