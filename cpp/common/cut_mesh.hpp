...
template <typename E> struct Cut_Part {
    ...
    Rd mapToPhysicalElement(const_element_iterator it, const RdHat Phat) const; ///< map a point in the reference element to the physical element
    ...
    const_element_iterator other_side_element_begin() const; ///< return an iterator to the beginning of the elements on the other side of the cut
    const_element_iterator other_side_element_end() const; ///< return an iterator to the end of the elements on the other side of the cut
