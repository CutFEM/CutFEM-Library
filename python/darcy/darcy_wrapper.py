...
lib = ct.cdll.LoadLibrary('build/lib/lib_darcy.dylib')
...
class DarcyCutFEM(object):
    ...
    def build_mesh(self, nx, ny, orx, ory, lx, ly):
        ...
        lib.Darcy2_build_mesh.argtypes = [
    ...
    def init_space(self, f, s):
        ...
        lib.Darcy2_init_space.argtypes = [
            ct.c_void_p, USER_FUN_LS, ct.c_char_p]
        lib.Darcy2_init_space(self.obj, f, s.encode('utf-8'))
    ...
    def set_stabilization_penalty(self, cu, cp):
        ...
        lib.Darcy2_set_stabilization_penalty.argtypes = [
    ...
    def add_macro_stabilization(self, dlt):
        ...
        lib.Darcy2_add_macro_stabilization.argtypes = [
    ...
    def solve(self):
        ...
        lib.Darcy2_give_back_sol.argtypes = [
