...
// this is outside the class? does it mean regardless of constructor these values are used?
const int TypeOfFE_RT0_2d::ifGeomOnItem[4] = {0,1,0,0}; // which geometry=vertex,edge,face,volume contains dofs
int TypeOfFE_RT0_2d::Data[] = // creates global numbering
...
// entries of alpha_Pi_h are replaced by function get_Coef_Pi_h below
// double TypeOfFE_RT0_2d::alpha_Pi_h[] = {0., 0., 0., 0., 0., 0.};

// Initialises the basis functions via bfMat
...
// Creates the object RT0, defined in data in GTypeOfFE.hpp
