...
// void write_paraview_vtu (std::ostream& file_, const Mesh3& t)
// {
//   file_ << "<?xml version=\"1.0\"?>"  << '\n'
//   	<< "<VTKFile type=\"UnstructuredGrid\" version=\"0.1\" byte_order=\"LittleEndian\">"   << '\n'
//   	<< "<UnstructuredGrid>"   << '\n';

//   file_<< "<Piece NumberOfPoints=\""<< t.nv <<"\" NumberOfCells=\""<< t.nt << "\">";
//   file_<< "\n\t<Points>"
//        << "\n\t\t<DataArray type=\"Float32\" NumberOfComponents=\"3\" format=\"" << "ascii\">\n\t\t";

//   for(Mesh3::const_vertex_iterator it= t.vertex_begin(), end= t.vertex_end();
//       it != end; ++it) {
...
//   	  <<"ascii\">\n\t\t";
//   for(Mesh3::const_element_iterator it= t.element_begin(), end= t.element_end();
//       it != end; ++it) {
//     file_ << (t)(it[0][0]) << ' ' << (t)(it[0][1]) << ' '
// 	  << (t)(it[0][2]) << ' ' << (t)(it[0][3]) << ' ';
//   }
